...
class TestBackgroundGenerators(unittest.TestCase):
    ...
    def _verify_basic_image_properties(
        self, image, expected_shape=None, expected_dtype=np.uint16
    ):
    ...
    def test_create_radial_gradient_background(self):
        ...
        bg = create_radial_gradient_background(self.height, self.width, center, True)
        self._verify_basic_image_properties(bg)
